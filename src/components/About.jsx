        ...
        <div ref={ref} className="reveal">
          ...
          <div className="grid md:grid-cols-2 gap-10 items-center">
            <div className="space-y-4">
              ...
              <p className="text-[15px] text-dim leading-relaxed">I've built <strong className="text-light">4 real projects</strong> and earned <strong className="text-light">8 HackerRank certifications</strong> across frontend, backend, and algorithms — and I'm just getting started.</p>
